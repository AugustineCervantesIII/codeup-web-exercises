(function() {
    ...
    let person = {
        ...
        sayHello: function greeting(){
            console.log('Hello from Augustine Cervantes!');
        }
    };
    ...
    shoppers.forEach(function(shopper){
        let initialAmount = shopper.amount;
        let discount = shopper.amount * .12;
        let discountAmount = initialAmount - discount;
        if (initialAmount > 200 ){
            console.log(shopper.name + " spent $" + initialAmount +
                ". They" + " get a discount of " + discount +
                ". The total payed is $" + discountAmount);
        } else {
