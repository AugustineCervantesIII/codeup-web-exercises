...
$(document).ready(function() {
    ...
    $('#main-heading').click(function(){
        ...
        $(this).html('<h4><em>My Sorting Hat</em></h4>');
    });
    // how can the font size be changed with .html()

    $('#gryffindor-house').click(function(){
        $(this).css('color', 'red');
    });

    $('#slytherin-house').click(function(){
    ...
    //this highlights the ul for any list items that are clicked
    $('li').click(function(){
        //method chaining
